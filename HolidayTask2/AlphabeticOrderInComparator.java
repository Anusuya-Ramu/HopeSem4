...
class student implements Comparable<student>{
    ...
    public int compareTo(student s){
        ...
        /*This uses lexicographical (dictionary) order for strings
        Java compares character by character using Unicode (ASCII values)
         */
...
public class AlphabeticOrderInComparator {
